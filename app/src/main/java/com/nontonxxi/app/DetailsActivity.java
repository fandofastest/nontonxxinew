...
import com.nontonxxi.app.adapters.CastCrewAdapter;
import com.nontonxxi.app.adapters.CommentsAdapter;
import com.nontonxxi.app.adapters.EpisodeAdapter;
import com.nontonxxi.app.adapters.DownloadAdapter;
import com.nontonxxi.app.adapters.HomePageAdapter;
import com.nontonxxi.app.adapters.LiveTvHomeAdapter;
import com.nontonxxi.app.adapters.ProgramAdapter;
import com.nontonxxi.app.adapters.ServerApater;
import com.nontonxxi.app.database.DatabaseHelper;
import com.nontonxxi.app.models.CastCrew;
import com.nontonxxi.app.models.GetCommentsModel;
import com.nontonxxi.app.models.CommonModels;
import com.nontonxxi.app.models.EpiModel;
import com.nontonxxi.app.models.PostCommentModel;
import com.nontonxxi.app.models.Program;
import com.nontonxxi.app.models.SubtitleModel;
import com.nontonxxi.app.models.single_details.Cast;
import com.nontonxxi.app.models.single_details.Director;
import com.nontonxxi.app.models.single_details.DownloadLink;
import com.nontonxxi.app.models.single_details.Episode;
import com.nontonxxi.app.models.single_details.Genre;
import com.nontonxxi.app.models.single_details.RelatedMovie;
import com.nontonxxi.app.models.single_details.Season;
import com.nontonxxi.app.models.single_details.SingleDetails;
import com.nontonxxi.app.models.single_details.Subtitle;
import com.nontonxxi.app.models.single_details.Video;
import com.nontonxxi.app.network.RetrofitClient;
import com.nontonxxi.app.network.apis.CommentApi;
import com.nontonxxi.app.network.apis.FavouriteApi;
import com.nontonxxi.app.network.apis.SingleDetailsApi;
import com.nontonxxi.app.network.apis.SubscriptionApi;
import com.nontonxxi.app.network.model.ActiveStatus;
import com.nontonxxi.app.network.model.AdsConfig;
import com.nontonxxi.app.network.model.FavoriteModel;
import com.nontonxxi.app.service.DownloadWorkManager;
import com.nontonxxi.app.utils.PreferenceUtils;
import com.nontonxxi.app.utils.ApiResources;
import com.nontonxxi.app.utils.ads.BannerAds;
import com.nontonxxi.app.utils.Constants;
import com.nontonxxi.app.utils.ads.PopUpAds;
import com.nontonxxi.app.utils.ToastMsg;
import com.nontonxxi.app.utils.Tools;
import com.nontonxxi.app.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.nontonxxi.app.Config.API_KEY, userId);
