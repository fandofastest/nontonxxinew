...
import com.nonton.xx1.adapters.CastCrewAdapter;
import com.nonton.xx1.adapters.CommentsAdapter;
import com.nonton.xx1.adapters.EpisodeAdapter;
import com.nonton.xx1.adapters.DownloadAdapter;
import com.nonton.xx1.adapters.HomePageAdapter;
import com.nonton.xx1.adapters.LiveTvHomeAdapter;
import com.nonton.xx1.adapters.ProgramAdapter;
import com.nonton.xx1.adapters.ServerApater;
import com.nonton.xx1.database.DatabaseHelper;
import com.nonton.xx1.models.CastCrew;
import com.nonton.xx1.models.GetCommentsModel;
import com.nonton.xx1.models.CommonModels;
import com.nonton.xx1.models.EpiModel;
import com.nonton.xx1.models.PostCommentModel;
import com.nonton.xx1.models.Program;
import com.nonton.xx1.models.SubtitleModel;
import com.nonton.xx1.models.single_details.Cast;
import com.nonton.xx1.models.single_details.Director;
import com.nonton.xx1.models.single_details.DownloadLink;
import com.nonton.xx1.models.single_details.Episode;
import com.nonton.xx1.models.single_details.Genre;
import com.nonton.xx1.models.single_details.RelatedMovie;
import com.nonton.xx1.models.single_details.Season;
import com.nonton.xx1.models.single_details.SingleDetails;
import com.nonton.xx1.models.single_details.Subtitle;
import com.nonton.xx1.models.single_details.Video;
import com.nonton.xx1.network.RetrofitClient;
import com.nonton.xx1.network.apis.CommentApi;
import com.nonton.xx1.network.apis.FavouriteApi;
import com.nonton.xx1.network.apis.SingleDetailsApi;
import com.nonton.xx1.network.apis.SubscriptionApi;
import com.nonton.xx1.network.model.ActiveStatus;
import com.nonton.xx1.network.model.AdsConfig;
import com.nonton.xx1.network.model.FavoriteModel;
import com.nonton.xx1.service.DownloadWorkManager;
import com.nonton.xx1.utils.PreferenceUtils;
import com.nonton.xx1.utils.ApiResources;
import com.nonton.xx1.utils.ads.BannerAds;
import com.nonton.xx1.utils.Constants;
import com.nonton.xx1.utils.ads.PopUpAds;
import com.nonton.xx1.utils.ToastMsg;
import com.nonton.xx1.utils.Tools;
import com.nonton.xx1.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.nonton.xx1.Config.API_KEY, userId);
