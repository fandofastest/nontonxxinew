...
public class Config {
    ...
    public static final String API_SERVER_URL = "https://new.pekanbarumedia.online/new_api/";
    ...
    public static final String TERMS_URL = "https://new.pekanbarumedia.online/admin/terms/";
