...
import com.watchxxi.freemovies.adapters.CastCrewAdapter;
import com.watchxxi.freemovies.adapters.CommentsAdapter;
import com.watchxxi.freemovies.adapters.EpisodeAdapter;
import com.watchxxi.freemovies.adapters.DownloadAdapter;
import com.watchxxi.freemovies.adapters.HomePageAdapter;
import com.watchxxi.freemovies.adapters.LiveTvHomeAdapter;
import com.watchxxi.freemovies.adapters.ProgramAdapter;
import com.watchxxi.freemovies.adapters.ServerApater;
import com.watchxxi.freemovies.database.DatabaseHelper;
import com.watchxxi.freemovies.models.CastCrew;
import com.watchxxi.freemovies.models.GetCommentsModel;
import com.watchxxi.freemovies.models.CommonModels;
import com.watchxxi.freemovies.models.EpiModel;
import com.watchxxi.freemovies.models.PostCommentModel;
import com.watchxxi.freemovies.models.Program;
import com.watchxxi.freemovies.models.SubtitleModel;
import com.watchxxi.freemovies.models.single_details.Cast;
import com.watchxxi.freemovies.models.single_details.Director;
import com.watchxxi.freemovies.models.single_details.DownloadLink;
import com.watchxxi.freemovies.models.single_details.Episode;
import com.watchxxi.freemovies.models.single_details.Genre;
import com.watchxxi.freemovies.models.single_details.RelatedMovie;
import com.watchxxi.freemovies.models.single_details.Season;
import com.watchxxi.freemovies.models.single_details.SingleDetails;
import com.watchxxi.freemovies.models.single_details.Subtitle;
import com.watchxxi.freemovies.models.single_details.Video;
import com.watchxxi.freemovies.network.RetrofitClient;
import com.watchxxi.freemovies.network.apis.CommentApi;
import com.watchxxi.freemovies.network.apis.FavouriteApi;
import com.watchxxi.freemovies.network.apis.SingleDetailsApi;
import com.watchxxi.freemovies.network.apis.SubscriptionApi;
import com.watchxxi.freemovies.network.model.ActiveStatus;
import com.watchxxi.freemovies.network.model.AdsConfig;
import com.watchxxi.freemovies.network.model.FavoriteModel;
import com.watchxxi.freemovies.service.DownloadWorkManager;
import com.watchxxi.freemovies.utils.PreferenceUtils;
import com.watchxxi.freemovies.utils.ApiResources;
import com.watchxxi.freemovies.utils.ads.BannerAds;
import com.watchxxi.freemovies.utils.Constants;
import com.watchxxi.freemovies.utils.ads.PopUpAds;
import com.watchxxi.freemovies.utils.ToastMsg;
import com.watchxxi.freemovies.utils.Tools;
import com.watchxxi.freemovies.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.watchxxi.freemovies.Config.API_KEY, userId);
